...
```{r}
map_df <- covid_food_merged 


map_by_anxiety <- covid_food_merged %>% 
  group_by(location, freq_feel_anxious, week) %>%
...
#export finalized df for age widget to csv
#write_sf(x = map_by_anxiety, "data/map_anxiety.")
